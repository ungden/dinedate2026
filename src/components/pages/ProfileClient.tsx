            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-black text-gray-900 leading-none mt-0.5">{formatCurrency(currentUser.wallet.balance)}</p>
                    </div>
                </div>
            ...
            <div className="ios-card bg-white divide-y divide-gray-50">
                <Link href="/vip-subscription" className="flex items-center justify-between p-4 hover:bg-gray-50 transition tap-highlight">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-gray-700">Nâng cấp VIP</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-[11px] font-black text-amber-600 bg-amber-50 px-2 py-0.5 rounded-lg uppercase tracking-tight">Active {currentUser.vipStatus.tier}</span>
                        <ChevronRight className="w-4 h-4 text-gray-300" />
                    </div>
                </Link>
                ...
                <Link href="/safety" className="flex items-center justify-between p-4 hover:bg-gray-50 transition tap-highlight">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-gray-700">Trung tâm an toàn</span>
                    </div>
                    <ChevronRight className="w-4 h-4 text-gray-300" />
                </Link>
                ...
                <Link href="/settings" className="flex items-center justify-between p-4 hover:bg-gray-50 transition tap-highlight">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-gray-700">Cài đặt tài khoản</span>
                    </div>
                    <ChevronRight className="w-4 h-4 text-gray-300" />
                </Link>
            </div>
